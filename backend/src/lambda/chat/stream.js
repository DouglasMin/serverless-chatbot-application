...
import { getConversationMetadata, getConversationMessages, putItem, convPK, updateConversationMetadata, } from "../libs/dynamo.js";
...
const handler = awslambda.streamifyResponse(async (event, responseStream) => {
    ...
    try {
        ...
        const { promptMessages, newSummary } = await buildPromptMessages(openai, convMeta.model, allMessages, convMeta.summaryContext);
